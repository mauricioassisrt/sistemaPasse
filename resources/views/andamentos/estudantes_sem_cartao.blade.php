    ...
    <div class="container-fluid">
        ...
        <div class="card card-light-dark">
            <div class="card-header">
                <h2 class="card-title"><strong> <i class="fas fa-tachometer-alt"></i> Estudantes sem cartão
                    </strong></h2>
            </div>
                            ...
                            <div class="card-body table-responsive p-0">
                                ...
                                @foreach ($objetoEstudantes as $estudante)
                                    <tr role="row" class="odd">
                                        <td tabindex="0"
                                            class="sorting_1">{{date('d/m/Y H:i:s', strtotime($estudante->data_cadastro)) }}</td>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ url('andamentos/iniciar') }}/{{$estudante->id  }}"
